...
class NoamScheduler(LRScheduler):
    ...
    def __init__(
        ...
        # Must call super().__init__ AFTER setting instance attrs
        # because it immediately calls get_lr()
    ...
    def _get_lr_scale(self) -> float:
        ...
        step = last_epoch + 1  (avoid step=0 division)
        scale = d_model^(-0.5) * min(step^(-0.5), step * warmup_steps^(-1.5))
        """
        step = self.last_epoch + 1  # step starts at 1
    ...
    def get_lr(self) -> list:
        ...
        Multiplies each group's base_lr by the Noam scale.
        """
...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("noam_lr.png")
    print("Saved noam_lr.png")'''
